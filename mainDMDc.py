from GraphDMD.Control.DMDc import DMDc
from GraphDMD.Control.face2faceC import Dataset
...
def main():
    ...
    exact, predict = DMD_touring(dmdc, dataset, ts_length, r, mode_selection=True)
    MAE, link, threshold = get_loss_list(dmdc, dataset, ts_length, r, mode_selection=True, binary=False)
